...
public class SendJacocoReports {

    public static void sendJacocoReport () {
...
//        Properties props = new Properties();
        ...
        try {
            ...
            message.setSubject("Code Coverage Test Report");

            // Create object to add multimedia type content
            BodyPart messageBodyPart1 = new MimeBodyPart();
            String messageBody = "Kindly have a look at the latest test automation report execution attached.";
            String htmlText = "<font size =\"4\" face=\"arial\" >Dear all,</font>" + "<br><br>" + "<font size =\"4\" face=\"arial\" >" + messageBody + "</font>" + "<br><br>" + "<font size =\"4\" face=\"arial\" >Many Thanks,</font>";
            messageBodyPart1.setContent(htmlText, "text/html");

            // Create another object to add another content
            MimeBodyPart messageBodyPart2 = new MimeBodyPart();

            String fileLocation = CompressFile.JACOCO_OUTPUT_ZIP_FILE;
            ...
            // set the file
            messageBodyPart2.setFileName("Code_Coverage_Automation_Report.zip");
//            messageBodyPart2.attachFile(fileLocation);
            ...
            System.out.println("=====Email Sent Successfully with Jacoco Report!!=====");
